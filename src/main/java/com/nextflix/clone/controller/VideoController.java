...
public class VideoController {
    ...
    public ResponseEntity<MessageResponse> createVideoByAdmin(
        ...
        return ResponseEntity.ok(
                videoService.createVideoByAdmin(videoRequest)
        );
    }
    ...
    public ResponseEntity<PageResponse<VideoResponse>> getAllAdminVideo (
        ...
        return ResponseEntity.ok(
                videoService.getAllAdminVideo(page, size, search)
        );
    }
    ...
    public ResponseEntity<MessageResponse> updateVideoByAdmin(
        ...
        return ResponseEntity.ok(
                videoService.updateVideoByAdmin(id, videoRequest)
        );
    }
    ...
    {
        return ResponseEntity.ok(
                videoService.deleteVideoByAdmin(id)
        );
    }
    ...
    {
        return ResponseEntity.ok(
                videoService.toggleVideoPublishedStatusByAdmin(id, status)
        );
    }
